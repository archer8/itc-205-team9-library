...
public class RestrictedPanel extends ABorrowPanel {
	...
	public RestrictedPanel(final IBorrowUIListener listener) {
		...
		this.setBorder(new TitledBorder((Border) null, "Scanning", 4, 2, (Font) null, (Color) null));
		this.setBounds(12, 23, 460, 640);
		JPanel panel_2 = new JPanel();
		panel_2.setBorder(new TitledBorder((Border)null, "Current Loan", 4, 2, (Font)null, (Color)null));
		panel_2.setBounds(10, 289, 434, 242);
		this.add(panel_2);
		panel_2.setLayout((LayoutManager)null);
		JPanel panel_4 = new JPanel();
		panel_4.setBorder(new TitledBorder(UIManager.getBorder("TitledBorder.border"), "Pending Loan List", 4, 2, (Font)null, (Color)null));
		...
		panel_5.setBorder(new TitledBorder((Border)null, "Current Book", 4, 2, (Font)null, (Color)null));
		...
		panel_3.setBorder(new TitledBorder((Border)null, "Borrower Details", 4, 2, (Font)null, (Color)null));
		...
		panel_6.setBorder(new TitledBorder((Border)null, "Existing Loans", 4, 2, (Font)null, (Color)null));
		...
		panel_7.setBorder(new TitledBorder((Border)null, "Borrowing Restrictions", 4, 2, (Font)null, (Color)null));
	...
	public void displayOutstandingFineMessage(float amountOwing) {
		this.lblFineLimit.setText(String.format("Borrower has outstanding fines. Amount owing: $%.2f", new Object[]{Float.valueOf(amountOwing)}));
	}

	public void displayOverFineLimitMessage(float amountOwing) {
		this.lblFineLimit.setText(String.format("Borrower has exceeded fine limit. Amount owing: $%.2f", new Object[]{Float.valueOf(amountOwing)}));
	}
